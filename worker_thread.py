...
class WorkerThread():
    ...
    def worker_thread(self):
        try:
            ...
            if (response != 206): # We expect 206 here because we requested a range, full content would break file on upload
                raise Exception(f"Received non 206 code ({response})")
